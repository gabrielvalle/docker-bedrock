...
if(!interface_exists('EkAndreas\DockerBedrock\ContainerInterface')) include_once 'src/DockerBedrock/ContainerInterface.php';
...
if(!class_exists('EkAndreas\DockerBedrock\Container')) include_once 'src/DockerBedrock/Container.php';
